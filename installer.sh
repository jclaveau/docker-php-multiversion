...
readonly installer="https://raw.githubusercontent.com/jclaveau/docker-php-multiversion/master/installer.sh"
readonly repo="https://github.com/jclaveau/docker-php-multiversion.git"
readonly archive="https://github.com/jclaveau/docker-php-multiversion/release"
readonly project="docker-php-multiversion"
readonly exec="php"
...
OPTIONS:
  -p, --prefix PREFIX   Specify prefix                 [default: \\\$HOME/opt]
...
trap finished EXIT
VERSION='' PREFIX=$HOME/opt BIN='' DIR='' SWITCH='' PRE='' YES='' FETCH=''
done='' mode=install
